...
_lr_signature = 'COMMA LPAREN NAME NUMBER PROJECT RENAME RPAREN SELECT STRINGAtomstart : NAME LPAREN args RPARENargs : args COMMA argargs : argarg  : NUMBERarg  : STRINGarg  : NAME'
